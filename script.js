...
let resultinfo = [{
        title: '斷捨離',
        img: '',
        state: '作為減物生活最初代表著作之一， <br>\
                適合給不知從何下手或仰賴豐富資訊的你。 <br>\
                <br>\
                斷捨離一書中，所闡述的減物法則，簡單而言也就是「斷」「捨」「離」三個步驟。 <br>\
                「斷」與「捨」是行為上的要求，斷絕不必要的物品獲取， <br>\
                以及捨去已堆積不會用的物品，從中得到「脫離」物欲執著的狀態， 屬精神層次的提升， <br>\
                也是作者不斷提到思維要從「看得到的世界」到「看不到的世界」改變的意思。 <br>\
                <br>\
    ...
    },
    {
        ...
        state: '「極簡主義者」的誕生代表作。<br>\
                ...
                作者懇切地分享了自己從垃圾屋到空無一物房間的過程），<br>\
                <br>\
                「極簡主義」比起「斷捨離」或是「怦然心動法則」，不太像是一個行動上的步驟建議，更多的是一個生活原則的建立，<br>\
                它沒有一定的答案或方法，相信每個人都有自己前進的方法，只是想讓你知道小而美的生活模式，<br>\
                知道你可以代表自己，而不用用擁有什麼展示自己。<br>\
                <br>\
                基本概念：\
                <br>\
                1.極簡不是目的，是方法<br>\
    ...
    },
    {
        title: '怦然心動的人生整理魔法',
        img: '',
        state: '2012年在日本大為暢銷的生活風格書籍，在測驗中推薦的另一本書「我決定簡單的生活」 作者也在自己的著作內反覆提到，\
                更強調了它出版後對極簡主義的奠基有著巨大的影響。<br>\
                <br>\
                「怦然心動的整理魔法」推薦給很了解自己、想更珍惜物品的你，<br>\
                對比其他兩本推薦書，減物的規則更加彈性，<br>\
                <br>\
                「能讓你怦然心動的物品通通可以留下！」這樣可愛的概念，<br>\
                目的是在塑造真正理想的環境，不把減少物品當成目標，而是透過減少不喜愛的物品，讓自己的生活更有愛。<br>\
                <br>\
                作者發下「只要實踐怦然心動法則，房間就再也不會變亂！」的保證，<br>\
                這樣的整理魔法，請你務必試試看！<br>\
                <br>\
                減物步驟：<br>\
                1.思考具體的理想的環境。<br>\
                2.丟東西。<br>\
                （同類的東西全部集中判斷，整理順序：衣服>書籍文件>雜物>紀念品）<br>\
                3.決定定位。<br>'
    }
]
